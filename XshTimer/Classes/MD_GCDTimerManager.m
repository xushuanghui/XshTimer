//
//  MD_GCDTimerManager.m
//  mandofin-ios
//
//  Created by shuanghui xu on 17/11/10.
//  Copyright © 2017年 bluesky. All rights reserved.
//

#import "MD_GCDTimerManager.h"

@interface MD_GCDTimerManager()
@property (nonatomic, strong) NSMutableDictionary *timerContainer;
@property (nonatomic, strong) NSMutableDictionary *actionBlockCache;
@end

@implementation MD_GCDTimerManager


#pragma mark - Public Method

//+ (MD_GCDTimerManager *)sharedInstance {
//    static MD_GCDTimerManager *_gcdTimerManager = nil;
//    static dispatch_once_t onceToken;
//
//    dispatch_once(&onceToken,^{
//        _gcdTimerManager = [[MD_GCDTimerManager alloc] init];
//    });
//
