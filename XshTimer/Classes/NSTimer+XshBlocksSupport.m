...
- (void)setActionBlockCache:(NSMutableDictionary *)actionBlockCache {
    objc_setAssociatedObject(self, @selector(actionBlockCache), actionBlockCache, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
}
